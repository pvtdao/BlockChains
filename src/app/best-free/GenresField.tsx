	...
	return (
		<div>
			<div className='flex items-center gap-2 mb-1'>
				<p className='font-poppins-bold'>Genres</p>
				<button
					type='button'
					onClick={() => append({ Code: 'Genres Code', Name: 'Genres Name' })}
			...
			{fields.map((item, idx) => {
				return (
					<div key={item.id} className='flex items-start gap-2 mb-3'>
						<TextField fullWidth name={`Genres[${idx}].Code`} />
						<TextField fullWidth name={`Genres[${idx}].Name`} />
						<button
